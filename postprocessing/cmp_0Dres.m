...
varn={'phyto_Q_N'; 'phyto_phytoplankton_C'; 'phyto_nut1'; 'phyto_nut2';...
  'phyto_Q_P';'total_phosphorus_calculator_result';'total_nitrogen_calculator_result';};
...
%  set(gca,'Box','on','Xlim',[min(tim) max(tim)],'Ylim',[ymin-eps ymax+eps]);%,'YTick',0:4,
  set(gca,'Box','on');  %,'Xlim',[7 11],'YTick',0:4,
