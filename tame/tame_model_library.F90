...
contains
 ...
 !      case ('npzdep');   allocate(type_tame_npzdep::model)
      ...
      case ('chemistry_phytoplankton');   allocate(type_tame_phytoplankton::model)
      case ('chemistry_detritus');   allocate(type_tame_detritus::model)
      case ('chemistry_nutrient');   allocate(type_tame_nutrient::model)
         !case ('chlorophyll');   allocate(type_chlorophyll::model)
