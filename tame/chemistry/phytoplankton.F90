...
module tame_chemistry_phytoplankton
...
use tame_stoich_functions
   ...
   type, extends(type_base_model), public :: type_tame_chemistry_phytoplankton
...
contains
   subroutine initialize(self, configunit)
      class (type_tame_chemistry_phytoplankton), intent(inout), target :: self
...
!              aggregate_variable=.true., conserved=.true.), self%id_phytoplankton_C, scale_factor = fixed_stoichiometry(i))
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      class (type_tame_chemistry_phytoplankton), intent(in) :: self
